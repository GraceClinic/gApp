 ...
 * << class description >>
 *
 * @package WordShuffle_Model_Instructions_Mappers
 *
 * @class WordShuffle_Model_Instructions_Mappers_Page
 *  
 */
class WordShuffle_Model_Instructions_Mapper_Page extends Common_Abstracts_Mapper
{
    ...
    public function findAll($by = null)
    {
        ...
        /** @var  WordShuffle_Model_Instructions_Page[] $results */
        $pages = parent::findAll($by);

        // process each page and retrieve the file contents for the body
        if(count($pages) > 0){
            /** @var WordShuffle_Model_Instructions_Page $page */
