 ...
 *
 * @class WordShuffle_Model_Mapper_Instructions
 *  
 */
class WordShuffle_Model_Mapper_Instructions extends Common_Abstracts_Mapper
{
     ...
     *
     * @param $id
     * @return WordShuffle_Model_Instructions_Page[]     - array of Page objects for the Instructions id
     * @throws Exception
     */
    protected function _findPages($id = null){
        ...
        if($id !== null){
            $pageModel = new WordShuffle_Model_Instructions_Page(array('idInstructions'=>$this->_model->id));
            ...
            for($i=0; $i<count($pages); $i++){
                $pages[$i] = new WordShuffle_Model_Instructions_Page($pages[$i]);
            }
        }
